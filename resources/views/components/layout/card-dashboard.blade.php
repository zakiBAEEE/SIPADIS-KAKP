...
<div
    class="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-lg shadow-slate-950/5 flex justify-center items-center h-[110px] shrink sm:flex-1 md:w-[100px] lg:w-[200px]">
