<div class="pb-4">
    ...
    <div id="drop-area"
        ...
        <input type="file" name="{{ $name }}" id="fileInput"
            class="absolute inset-0 opacity-0 z-10 cursor-pointer h-full" accept="image/*,.pdf" />

        <div class="flex flex-col items-center pointer-events-none h-full">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 mb-2 text-slate-400 group-hover:text-blue-500"
